...
if ( is_home() ) {
	...
	?>
	<section id="chic-products"  class="boxed-wrapper clear-fix">
		<h2 class="chic-title">Nouvelle collection pièces de créateur à prix cassés</h2>
		<?php
	...
	<section id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">Vos boutiques achat/vente de marques de luxe</h2>
